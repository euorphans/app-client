...
export const NavbarItems: {
  ...
  footerItems: {
    ...
    items: [
      ...
      {
        path: 'https://discord.com/invite/kbjrHZsCPd',
        icon: {
          position: 'center',
          element: (
            <svg
      ...
      {
        path: 'https://www.youtube.com/channel/UCc1PTjCGLK0e_wlXXO_TiTQ',
        icon: {
          position: 'center',
          element: (
            <svg
      ...
      {
        path: 'https://vk.com/dangerzonevw',
        icon: {
          position: 'center',
          element: (
            <svg
...
export const NotifySidebar: {
  ...
  settings: {
    header: {
      ...
      content: (
        <span className={sidebarStyle.info}>
          <span className={sidebarStyle.username}>Уведомления</span>
        </span>
      )
    },
    close: true
...
export const ProfileItems = (user: UserInterface, logout: any) => {
  return {
    settings: {
      header: {
        show: true,
...
export const pickSelection: ButtonsSliderType = [
  {
    item: (
      <button
        style={{
  ...
  },
  {
    item: (
      <button
        ...
        <span style={{ color: 'var(--black100)' }}>Обычный</span>
      </button>
    ),
    index: 1
  }
