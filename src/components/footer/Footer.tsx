        ...
        {topPeace && (
          <div className={style.head}>
            ...
            <div className={style.item}>
              ...
              <Link to={'/rules'} className={style.text}>
                Правила организации
              </Link>
              <Link to={RoutesEnum.SUBSCRIPTION_PAGE} className={style.text}>
                Платные подписки
              </Link>
              <Link to={'/personal'} className={style.text}>
                Персонал
              </Link>
              <Link to={'/brandbook'} className={style.text}>
                Брендбук
              </Link>
            </div>
            <div className={style.item}>
              <span className={style.title}>Другое</span>
              <Link to={'/projects'} className={style.text}>
                Другие наши проекты
              </Link>
              <Link to={'/partnership'} className={style.text}>
                Сотрудничество
              </Link>
              <Link to={'/help'} className={style.text}>
                Центр поддержки
              </Link>
              <Link to={'/api'} className={style.text}>
                API
              </Link>
            </div>
            <div className={style.item} style={{ justifyContent: 'space-between' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
                ...
                <div className={style.socials}>
                  ...
                  <a
                    target={'_blank'}
                    href={'https://discord.com/invite/kbjrHZsCPd'}
                    rel="noreferrer">
                    <svg
                      viewBox="0 0 16 12"
                      fill="none"
                  ...
                  <a
                    target={'_blank'}
                    href={'https://www.youtube.com/channel/UCc1PTjCGLK0e_wlXXO_TiTQ'}
                    rel="noreferrer">
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                  ...
                  <a target={'_blank'} href={'https://vk.com/dangerzonevw'} rel="noreferrer">
                    <svg
                      fill="none"
                      width="22"
                      height="22"
