...
export const SearchIcon: FC<IconI> = ({ viewBox, fill, height, width }) => {
  return (
...
export const ArrowIcon: FC<IconI> = ({ viewBox, fill, height, width }) => {
  return (
    <div style={{ display: 'flex', width: width, height: height }}>
      <svg
        viewBox={viewBox ? viewBox : '0 0 25 24'}
...
export const LightIcon: FC<IconI> = ({ viewBox, fill, height, width }) => {
  return (
    <div style={{ display: 'flex', width: width, height: height }}>
      <svg
        viewBox={viewBox ? viewBox : '0 0 25 24'}
...
export const FlyIcon: FC<IconI> = ({ viewBox, fill, height, width }) => {
  return (
    <div style={{ display: 'flex', width: width, height: height }}>
      <svg
...
export const LogoIcon: FC<IconI> = ({ viewBox, fill, height, width }) => {
  return (
    <div style={{ display: 'flex', width: width, height: height }}>
      <svg
        width={width ? width : '38'}
        height={height ? height : '42'}
        viewBox={viewBox ? viewBox : '0 0 380 435'}
        fill={fill ? fill : 'none'}
        xmlns="http://www.w3.org/2000/svg">
        <path
          d="M0 93.2727L171.41 0V432L117.538 328.909V100.636L51.4231 137.455V218.455V292.091L117.538 328.909L171.41 432L0 328.909V93.2727Z"
          fill="black"
        />
        <path
          d="M382 93.2727L210.59 0V203.727L264.462 171.818V110.455L337.923 152.182L210.59 228.273H269.359H328.128L382 203.727V275.378L264.462 338.727V260.182L328.128 228.273H269.359H210.59V432L382 328.909V93.2727Z"
          fill="black"
        />
      </svg>
    </div>
...
export const ShareIcon: FC<IconI> = ({ viewBox, fill, height, width }) => {
  return (
    <div style={{ display: 'flex', width: width, height: height }}>
      <svg
        viewBox={viewBox ? viewBox : '0 0 24 24'}
...
export const DotsIcon: FC<IconI> = ({ viewBox, fill, height, width }) => {
  return (
    <div style={{ display: 'flex', width: width, height: height }}>
      <svg
        viewBox={viewBox ? viewBox : '0 0 24 24'}
...
export const CloseIcon: FC<IconI> = ({ viewBox, fill, height, width }) => {
  return (
    <div style={{ display: 'flex', width: width, height: height }}>
      <svg
        viewBox={viewBox ? viewBox : '0 0 24 24'}
...
export const AddIcon: FC<IconI> = ({ viewBox, fill, height, width }) => {
  return (
    <div style={{ display: 'flex', width: width, height: height }}>
      <svg
        viewBox={viewBox ? viewBox : '0 0 24 24'}
...
export const ShieldIcon: FC<IconI> = ({ viewBox, fill, height, width }) => {
  return (
    <div style={{ display: 'flex', width: width, height: height }}>
      <svg
...
export const CheckIcon: FC<IconI> = ({ viewBox, fill, height, width }) => {
  return (
    <div style={{ display: 'flex', width: width, height: height }}>
      <svg
        viewBox={viewBox ? viewBox : '0 0 24 24'}
...
export const StarBackgroundIcon: FC<IconI> = ({ viewBox, fill, height, width }) => {
  return (
    <div style={{ display: 'flex', width: width, height: height }}>
      <svg
        viewBox={viewBox ? viewBox : '0 0 24 24'}
        ...
        height={height ? height : '24'}
        xmlns="http://www.w3.org/2000/svg">
        <rect width="24" height="24" rx="8" fill="#16161a" />
        <path
...
export const StarIcon: FC<IconI> = ({ viewBox, fill, height, width, settings }) => {
  return (
...
export const Star: FC<IconI> = ({ viewBox, fill, height, width, settings }) => {
  return (
    <svg
      viewBox={viewBox ? viewBox : '0 0 24 24'}
      fill={fill ? fill : 'none'}
...
export const AddImageIcon: FC<IconI> = ({ viewBox, fill, height, width }) => {
  return (
    <div style={{ display: 'flex', width: width, height: height }}>
      <svg
...
export const VkIcon: FC<IconI> = ({ viewBox, fill, height, width }) => {
  return (
    <div style={{ display: 'flex', width: width, height: height }}>
      <svg
...
export const YouTubeIcon: FC<IconI> = ({ viewBox, fill, height, width }) => {
  return (
    <div style={{ display: 'flex', width: width, height: height }}>
      <svg
        viewBox={viewBox ? viewBox : '0 0 16 16'}
...
export const DiscordIcon: FC<IconI> = ({ viewBox, fill, height, width }) => {
  return (
    <div style={{ display: 'flex', width: width, height: height }}>
      <svg
        viewBox={viewBox ? viewBox : '0 0 16 16'}
...
export const TelegramIcon: FC<IconI> = ({ viewBox, fill, height, width }) => {
  return (
    <div style={{ display: 'flex', width: width, height: height }}>
      <svg
        viewBox={viewBox ? viewBox : '0 0 24 24'}
