...
export const LogoIcon: FC<Icon> = ({ viewBox, fill, height, width }) => {
  return (
    <div style={{ display: 'flex', width: width, height: height }}>
      <svg
        viewBox={viewBox ? viewBox : '0 0 43 50'}
        fill={fill ? fill : 'none'}
        width={width ? width : 43}
        height={height ? height : 50}
        xmlns="http://www.w3.org/2000/svg">
        <path
          d="M0 10.7955L19.0705 0V50L13.0769 38.0682V11.6477L5.72115 15.9091V25.2841V33.8068L13.0769 38.0682L19.0705 50L0 38.0682V10.7955Z"
          fill="#16161A"
        />
        <path
          d="M42.4999 10.7955L23.4294 0V23.5795L29.423 19.8864V12.7841L37.5961 17.6136L23.4294 26.4205H29.9679H36.5064L42.4999 23.5795V31.8725L29.423 39.2045V30.1136L36.5064 26.4205H29.9679H23.4294V50L42.4999 38.0682V10.7955Z"
          fill="#16161A"
        />
      </svg>
    </div>
...
export const Star: FC<Icon> = ({ viewBox, fill, height, width, settings }) => {
  return (
    <svg
      viewBox={viewBox ? viewBox : '0 0 24 24'}
      fill={fill ? fill : 'none'}
