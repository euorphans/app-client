...
export namespace Home {
  ...
  export const HeadingTabs: FC<{ children: React.ReactNode }> = ({ children }) => {
    return <div className={style.tabs}>{children}</div>;
  };

  export const ArticlesWrapper: FC<{ children: React.ReactNode }> = ({ children }) => {
    return <div className={style.articles}>{children}</div>;
  };

  export const ArticleHeading: FC<{ children: React.ReactNode }> = ({ children }) => {
    return (
  ...
  export const ArticleItem: FC<{ image: string; title: string; date: string; url: string }> = ({
    image,
    date,
    title,
    url
